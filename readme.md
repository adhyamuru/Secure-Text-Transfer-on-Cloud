...
We, here have implemented a secure text transfer using diffie-hellman key exchange algorithm. This enables to transfer private data securely on a public cloud.
